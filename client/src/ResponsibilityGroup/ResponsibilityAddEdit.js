...
const ResponsibilityAddEdit = () => {
  ...
  useEffect(() => {
    if (responsibilityid) {
      axios
        .get(API.VIEW_RESPONSIBILITYGROUP_API(responsibilityid))
  ...
  const handlSubmit = (e) => {
    ...
    if (
      ...
      if (!responsibilityid) {
        axios
          .post(API.ADD_RESPONSIBILITYGROUP_API, {
            responsibilitytype,
            responsibilitytypedescription,
            iconupload,
            fileupload,
        ...
        axios
          .put(API.UPDATE_RESPONSIBILITYGROUP_API(responsibilityid), {
            responsibilitytype,
            responsibilitytypedescription,
            iconupload,
            fileupload,
  ...
  return (
    <div style={{ marginTop: " 100px" }}>
      ...
      >
        ...
        />
        <label htmlFor="responsibilitytypedescription">
