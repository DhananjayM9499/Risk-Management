...
const RiskAddEdit = () => {
  ...
  useEffect(() => {
    if (riskcategoryid) {
      axios
        .get(API.VIEW_RISKCATEGORY_API(riskcategoryid))
  ...
  const handlSubmit = (e) => {
    ...
    if (
      ...
      if (!riskcategoryid) {
        ...
        const checkboxValue = checkbox ? true : false;
        axios
          .put(API.UPDATE_RISKCATEGORY_API(riskcategoryid), {
            categorycode,
            categoryname,
            fileupload,
            categorytype,
    ...
    <div style={{ marginTop: " 100px" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <a
            href="http://drive.google.com/drive/folders/18xEFIS66wqfRQWjcAzJnE19-l39gFZIT?usp=share_link"
            target="_blank"
