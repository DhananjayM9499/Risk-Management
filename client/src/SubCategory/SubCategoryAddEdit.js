...
const SubCategoryAddEdit = () => {
  ...
  useEffect(() => {
    if (subcategoryid) {
      axios
        .get(API.VIEW_SUBCATEGORY_API(subcategoryid))
  ...
  const handlSubmit = (e) => {
    ...
    if (
      ...
      if (!subcategoryid) {
        ...
        axios
          .put(API.UPDATE_SUBCATEGORY_API(subcategoryid), {
            subcategorytype,
            subcategorytypedescription,
            iconupload,
            fileupload,
  ...
  return (
    <div style={{ marginTop: " 100px" }}>
      ...
      >
        ...
        />
        <label htmlFor="subcategorytypedescription">
